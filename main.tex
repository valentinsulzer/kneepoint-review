...
In short, the impact of interactions, heterogeneity, and variation on knee pathways is poorly understood and an opportunity for future work.
...
% \end{subfigure}%
\caption{Linear relation between knee point and capacity EOL (defined as 80\% capacity) for a total of 306 cells across 15 datasets. R-square goodness-of-fit measure is $0.869$. Bacon-Watts algorithm employed for the knee point identification. }
\label{fig:knees2EOL}
\end{figure}
...
\ybox{See table in Excel document tab 'SI-Exp Tables'.}
