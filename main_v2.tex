...
\begin{figure}[p]
    \centering
    \includegraphics[scale=0.8]{final_figures/pathway_trajectory_summary.pdf}
    \caption{
...
The plated lithium, which has a much lower density than intercalated lithium, further decreases the porous volume fraction, creating a positive feedback loop for additional lithium plating\cite{yang_modeling_2017} (Figure \ref{fig:plating_pathways}a).
...
This scenario may occur in cells with unstable positive electrodes, such as nickel-rich materials (cite myung-nickel-rich-2016 and manthiram-perspective-2017 and Laszczynski-understanding-2019), cycling under conditions such that the rate of positive electrode material loss exceeds the rate of lithium inventory loss.
...
For instance, average charge and discharge voltage are readily accessible features that can indicate rapid changes in lithium inventory loss or internal resistance growth rates.(cite harlow-asymmetric)
