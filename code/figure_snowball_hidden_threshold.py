...
ax[2].plot(cycle_numbers, knee_retention, color="tab:orange")
...
ax[5].plot(cycle_numbers_subset1, threshold_degradation1, "--", color="tab:orange")
ax[5].plot(cycle_numbers_subset2, threshold_degradation2, "--", color="tab:orange")
