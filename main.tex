...
Furthermore, locating a knee by eye is seemingly straightforward for a single, smooth and ideal health profile (e.g.\, around 400 cycles in Figure \ref{fig:degradation_shapes}) \gbox{is this the correct fig? not Fig \ref{fig:knee_definition3} (left)}.
...
\pbox{Propose moving this to later section} \cmark \gbox{please do}}
\label{fig:knees2EOL}
\end{figure}
...
\pbox{Move content here from section 2}
