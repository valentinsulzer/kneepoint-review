...
% \author[1]{Peter M. Attia\thanks{peter.m.attia@gmail.com}} 
% \author[7]{Alexander Bills} 
% \author[3]{Philipp Dechent} 
% \author[10]{Gonçalo dos Reis} 
% \author[11]{Matthieu Dubarry} 
% \author[4]{Paul Gasper} 
% \author[6]{Samuel Greenbank} 
% \author[6]{David Howey} 
% \author[8]{Edwin Khoo}  
% \author[9]{Ferran Brosa Planella} 
% \author[5]{Yuliya Preger}  
% \author[12]{Abhishek Soni} 
% \author[7]{Shashank Sripad} 
% \author[2]{Anna G. Stefanopoulou}  
% \author[2]{Valentin Sulzer}  
% \author[7]{Venkatasubramanian Viswanathan} 


% \affil[1]{Department of Materials Science and Engineering, Stanford University, Stanford, California 94305, United States}
% \affil[2]{University of Michigan, Ann Arbor, MI, US}
% \affil[3]{Institute for Power Electronics and Electrical Drives (ISEA), RWTH Aachen University, 2066 Aachen, Germany}
% \affil[4]{National Renewable Energy Laboratory, 15013 Denver West Pkwy, Golden, CO, 80401, USA}
% \affil[5]{Sandia National Laboratories, 1515 Eubank Blvd SE, Albuquerque, NM, 87185, USA}
% \affil[6]{Department of Engineering Science, University of Oxford, Parks Road, Oxford, OX1 3PJ, United Kingdom, and Faraday Institution, Harwell, United Kingdom}
% \affil[7]{Department of Mechanical Engineering, Carnegie Mellon University, Pittsburgh, PA, 15213}
% \affil[8]{Institute for Infocomm Research, Agency for Science, Technology, and Research (A*STAR), 1 Fusionopolis Way, Connexis, Singapore 138632, Singapore}
% \affil[9]{WMG, University of Warwick, Coventry, CV4 7AL, United Kingdom}
% \affil[10]{School of Mathematics, University of Edinburgh, The King’s Buildings, Edinburgh, EH9 3FD, UK}
% \affil[11]{Hawaii Natural Energy Institute, University of Hawaii, Honolulu, HI 96822}
% \affil[12]{Please insert affiliation here Abhishek}
...
For cylindrical cells, ...(philipp to add)
In addition with CT studies by Pfrang et al.~\cite{pfrang_long-term_2018} revealed jelly roll deformation in 18650s, using cells from Ecker et al. \cite{ecker_calendar_2014}. Threshold mechanism?
