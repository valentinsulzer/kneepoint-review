...
In Table \ref{table:experimental_summary_DATASOURCES}, we summarize the capacity curves extracted from figures found in the literature that were used to generate Figure X in the main manuscript. We recommend the reader to additionally compare Table \ref{table:experimental_summary_DATASOURCES} here with Table II in the main manuscript.
